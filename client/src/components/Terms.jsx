...
const Privacy = () => (
  <div className="container terms mb-5">
    <div className="row">
      <div className="col-md-12">
        <div className="privacy-bx ">
          ...
          <p>
            <small>
              Listed company names are trademarks™ or registered® trademarks of
              their respective holders. Use of them does not imply any
              affiliation with or endorsement by them
            </small>
          </p>
          <p>
            We are not affiliated or have a partnership with Facebook, any
            Facebook Company, nor any social media platforms or sites.
          </p>
          <p>
            This website is operated by Chimaera Network. Throughout the site,
            the terms “we”, “us” and “our” refer to [Chimaera Network.]. The
            Chimaera Network offers this website, including all information,
          ...
          <p>
            ...
            we may attempt to notify you by contacting the email and/or billing
          ...
          <p>
            ...
            <a href="mailto:support@chimaera.co">support@chimaera.co</a>
            <br />
          </p>
        </div>
      </div>
